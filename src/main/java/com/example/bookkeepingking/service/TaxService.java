package com.example.bookkeepingking.service;


import com.example.bookkeepingking.database.DatabaseUtil;
...
public class TaxService {
    ...
    public Employee calculateStateDeductions(Employee employee) {
        // first get the saved employee from db
        ...
        //return employee.getPayroll().getStateIncomeTax()
        return employee;
    }
