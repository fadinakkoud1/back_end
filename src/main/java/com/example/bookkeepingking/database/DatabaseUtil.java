package com.example.bookkeepingking.database;
...
public class DatabaseUtil {
    ...
    //make employee table to fetch the whole info at once
//    public static Employee getEmploye(String query) {
//        Employee employee;
//
//        try {
//            Connection connection = getConnection();
...
//
//            while (rs.next()) {
//                employee. = result = rs.getDouble(1);
//            }
//        } catch (SQLException throwables) {
//            throwables.printStackTrace();
//        } catch (ClassNotFoundException e) {
